...
export default function Home() {
	...
	function getBackgroundImage(): string {
		if (isGhDeployment) return "bg-[url(/fire-home/images/makima2.jpg)]";
	...
	return (
		<div className={`w-full h-svh overflow-clip bg-cover bg-center ${isAnime ? backgroundImage : "bg-black"}`}>
			<div className={`w-full h-full overflow-y-scroll overflow-x-clip flex flex-col items-center p-8`}>
				<div className="gap-x-4 md:gap-0 m-2 mb-16 w-full flex items-center flex-wrap md:flex-nowrap justify-between px-6 md:px-0 md:justify-evenly">
					...
					<div className="flex md:w-1/3 items-center justify-end md:px-12">
				...
				<div id="content-div" className="flex max-w-screen-2xl flex-wrap justify-center">
